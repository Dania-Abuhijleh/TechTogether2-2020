    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(30.0, 224.0),
            child: Container(
              width: 310.0,
              height: 66.0,
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(6.0),
                color: const Color(0xffa2424e),
              ),
            ),
          ),
        ],
...
const String _svg_ma8f44 =
    '<svg viewBox="27.5 160.5 252.0 1.0" ><path transform="translate(30.5, 160.5)" d="M 0 0 L 249 0" fill="none" fill-opacity="0.3" stroke="#54ba81" stroke-width="5" stroke-opacity="0.3" stroke-miterlimit="4" stroke-linecap="round" /><path transform="translate(27.5, 160.5)" d="M 0 0 L 205 0" fill="none" fill-opacity="1.0" stroke="#54ba81" stroke-width="5" stroke-opacity="1.0" stroke-miterlimit="4" stroke-linecap="round" /></svg>';
