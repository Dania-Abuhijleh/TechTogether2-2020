...
class LogIn extends StatelessWidget {
        ...
        children: <Widget>[
          ...
          Transform.translate(
            ...
            child:
              ...
              bounds: Rect.fromLTWH(11.0, 10.9, 14, 15.0),                    size: Size(219.0, 33.0),
                    pinLeft: true,
                    fixedWidth: true,
                    fixedHeight: true,
                    child:
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    // bounds: Rect.fromLTWH(13, 10, 15, 1),
                    bounds: Rect.fromLTWH(12.0, 9.9, 13, 15.0),
  ...
  void _addFriend() async {
    ...
    Map<String, dynamic> row = {
      DatabaseHelper.fr_id : 2,
      DatabaseHelper.fr_name  : "Ariana Grande",
      DatabaseHelper.fr_PRINTS : 821,
      DatabaseHelper.fr_Level  : 32,
      DatabaseHelper.USER_ID  : 1,

    };
    final id = await dbHelper.addFriend(row);
    print('inserted row id: fr_id');
  }
  void _addTask(int multiplier) async {
    // row to insert
    Map<String, dynamic> row = {
      DatabaseHelper.completionID : 2,
      DatabaseHelper.taskName  : "Shopping at Farmer’s Market",
      DatabaseHelper.gainedXP : 10 * multiplier,
      DatabaseHelper.frequency  : DatabaseHelper.frequency,
      DatabaseHelper.USER_ID  : 1,
      DatabaseHelper.taskID  : 1,

    };
    final id = await dbHelper.completeTask(row, multiplier);
    print('inserted row id: completionID');
  }
/*
  void _query() async {
